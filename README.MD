...
GwLogger attempts to use the same write buffer for all loggers with the same filename, which helps keep timestamps in proper order during heavy logging periods. 
